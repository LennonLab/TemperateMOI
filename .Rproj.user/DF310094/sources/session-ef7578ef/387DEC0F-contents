###README FOR 0000_Lohman/SporeMOI
...
## archive/ folder can be safely ignored (it includes reference code that was used to inform SporeMOI and/or old code drafts)
